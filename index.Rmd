...
### GAS Hierarchy - Increase the ability to complete weekly reading assignments for Science and Health classes
...
status_plot_all <- ggplot(status_all, aes(session, status)) +
  ...
  theme(plot.title = element_text(color = "black", face = "bold", hjust = 0.5)) +
  labs(x = "Session",
       y = "Percentage of Weekly Reading Assignments\n Completed for Health and Science Classes",
