...
freq_plot_1 <- ggplot(strategy, aes(session, freq)) +
  ...
  labs(x = "Session",
       y = "Percent",
       title = "Percentage of Assignments Entered into Planner per Week") 
...
freq_plot_2 <- ggplot(strategy, aes(session, freq_2)) +
  ...
  labs(x = "Session",
       y = "Days",
       title = "Number of Days per Week Participant used Planner to Track Assignments") 
...
help_plot <- ggplot(strategy, aes(session, help)) +
  ...
  labs(x = "Session",
       ...
       title = "Perceived Helpfulness of Academic Planner",
